...
class declaration_report_aib(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(declaration_report_aib, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw(
    'report.declaration.aib', 
    'declaration.report', 
    'addons/l10n_bj_declaration/report/declaration_report_aib.rml', 
    parser=declaration_report_aib, 
    header="external")
